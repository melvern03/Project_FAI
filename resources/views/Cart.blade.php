    ...
    <div class="container" >
        <div class="card-deck mb-3 text-center">
            ...
            <div class="card-body">
                ...
                <a href="/pilih/grab"  class="btn btn-lg btn-block btn-primary">Choose</a>
            </div>
            </div>
            <div class="card mb-4 shadow-sm">
            <div class="card-header">
            ...
            <div class="card-body">
                ...
                <a href="/pilih/jne"  class="btn btn-lg btn-block btn-primary">Choose</a>
            </div>
            </div>
            <div class="card mb-4 shadow-sm">
            <div class="card-header">
            ...
            <div class="card-body">
                ...
                <a href="/pilih/sicepat"  class="btn btn-lg btn-block btn-primary">Choose</a>
            </div>
            </div>
        </div>
    </div>
