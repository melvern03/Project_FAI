...
{{-- End Toast --}}
    <div class="wrapper" style="width: 100%;">
        <form id='addBaju' method="POST" action="/admin/addNew" enctype="multipart/form-data">
            @csrf
            ...
            <b>Gambar Model : </b> <input type="file" name="gambarModel" id="image-source" onchange="previewImage();"
                required>
            <br>
...
@if (Session("Sucess"))
    ...
    @endphp
@elseif(Session("Errors") || $errors->any())
    @php
